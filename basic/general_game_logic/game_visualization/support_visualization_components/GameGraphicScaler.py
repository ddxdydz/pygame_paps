from basic.general_game_logic.game_visualization.support_visualization_components.ImageLibrary import ImageLibrary
from basic.tools.get_surface_size_by_screen_proportions import get_surface_size_by_screen_proportions


class GameGraphicScaler(ImageLibrary):
